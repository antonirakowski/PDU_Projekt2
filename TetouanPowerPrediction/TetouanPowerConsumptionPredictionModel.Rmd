...
KNeighborsRegressor, GradientBoostingRegressor, RandomForestRegressor are 
similarly accurateand SupportVectorRegressor is less accurate than 
the former three.
The GradientBoostingRegressor proved to be most accurate with a 
slight upperhand. Let's train it again with more n_estimators
